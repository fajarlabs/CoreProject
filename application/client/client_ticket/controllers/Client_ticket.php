...
class Client_ticket extends MY_Controller 
{
	...
	{
		parent::__construct();
		$this->load->model(array("Client_ticket_model"));
	...
	public function page_list_rest()
	{
        ...
        $ticket_open = $result[$i]->IS_TICKET_OPEN;
				...
				if($ticket_read == 1) {
					$result[$i]->IS_TICKET_READ = '<span class="badge badge-success">Read By Anton</span>';
				} else {
					$result[$i]->IS_TICKET_READ = '<span class="badge badge-danger">Unread By Admin</span>';
        }
