...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Client Ticket Management <small>Function to edit client ticket</small></h1>
	<!-- end page-header -->
                ...
                <div class="panel-body" style="overflow-x: hidden;">
					...
					<table class="table table-striped  table-bordered">
						...
						<tr>
							...
							<td><?php echo form_textarea(array('value' => @$item->result()[0]->CLIENT_TICKET_DESCRIPTION,'type' => 'text', 'name' => 'client_ticket_description','class' => 'form-control')); ?></td>
						</tr>
