...
<head>
<title>PT Superintending Company of Indonesia (Persero),</title>
        ...
        <div id="header-custom"  class="rd-navbar-inner">
          ...
          <div class="rd-navbar-group">
            <div class="rd-navbar-panel">
              ...
              <span style="font-size: 30px;color:#f1f1f1;">Sistem Informasi Custody Transfer<br /><br /></span>
              <br />
              <span style="margin-top:15px;font-size: 20px;color:#f1f1f1;">Produk Migas dan Petrokimia</span> 
              </a> </div>
