            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                    	<a href="<?php echo base_url(); ?>index.php/admin_ticket" class="btn btn-xs btn-icon btn-circle btn-primary" ><i class="fa fa-reply"></i></a>
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                    ...
                    <ul class="chat">
                        ...
                        <li class="right clearfix"><span class="chat-img pull-right">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    ...
                                    <strong class="pull-right primary-font"><?php echo get_admin_firstname().' '.get_admin_lastname(); ?></strong>
                                </div>
                                <p>
                        ...
                        <li class="left clearfix"><span class="chat-img pull-left">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font"><?php echo get_client_name_by_id($row->USER_ID); ?></strong> <small class="pull-right text-muted">
                	...
                	<br />
                	<?php echo form_open_multipart('admin_ticket/reply_save/'.$reply_id,array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td><?php echo form_textarea(array('type' => 'text', 'name' => 'admin_ticket_description','class' => 'form-control')); ?></td>
						</tr>
						...
						<tr>
							<td>
							<?php echo anchor('/admin_ticket','Back', array('title' => 'Back to Admin Ticket list', 'class' => 'btn btn-sm btn-primary')); ?>
