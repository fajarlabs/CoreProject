...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Element Connection Management <small>Function to create connection element</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Element Connection Management - Table</h4>
                </div>
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('element_connection/save',array('id' => 'form_add')); ?>
						...
						<tr>
							...
							<?php if($intervention->num_rows() > 0) : 
								foreach($intervention->result() as $row) :
									echo '<option value="'.$row->ID.'">'.$row->INTERVENTION_NAME.'</option>';
								endforeach;
							endif; ?>
							</select>
							</td>
