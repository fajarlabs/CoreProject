...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Skill & Experience Management <small>Function to edit Skill & Experience</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('skill/update/'.$id,array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							...
							<td>
								...
								<div class="row">
									<div class="col-md-12">
										<?php echo form_input(array('type' => 'text', 'name' => 'skill','class' => 'form-control','required' => 'required','maxlength' => 50,'value' => @$item->result()[0]->EXP_TYPE)); ?>
									</div>
								</div>
							</td>
						</tr>
