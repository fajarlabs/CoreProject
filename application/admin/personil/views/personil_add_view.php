                ...
                <div class="panel-body" style="overflow-x: hidden;">
					...
					<table class="table table-striped  table-bordered">
						<tr>
							...
							<td><?php echo form_input(array('type' => 'text', 'name' => 'branch','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo form_input(array('type' => 'text', 'name' => 'total','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
						...
						<tr>
							<td colspan="2">
							<?php echo anchor('/personil','Back', array('title' => 'Back to Bbm list', 'class' => 'btn btn-sm btn-primary')); ?>
