            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                    	<a href="<?php echo base_url(); ?>index.php/personil/add/<?php echo $id ?>" class="btn btn-xs btn-icon btn-circle btn-primary" ><i class="fa fa-plus"></i></a>
                ...
                <div class="panel-body" style="overflow-x: hidden;">
					...
					<table class="table table-striped  table-bordered">
						...
						<tr>
							...
							<td> 
								<input required type="hidden" value="<?php echo $id ?>" name="type_location" id="type_location">
						...
						<tr>
							<td colspan="2">
							<?php echo anchor('/personil/detail/'.$id,'Back', array('title' => 'Back to Personil list', 'class' => 'btn btn-sm btn-primary')); ?>
