...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Branch Management <small>Function to edit branch</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open('cabang/update/'.$id,array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Branch Name*') ?></td>
							<td><?php echo form_input(array('value' => @$item->result()[0]->BRANCH_NAME,'type' => 'text', 'name' => 'cabang_name','class' => 'form-control','required' => 'required')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Branch Description*') ?></td>
							<td><?php echo form_textarea(array('value' => @$item->result()[0]->BRANCH_DESCRIPTION,'type' => 'text', 'name' => 'cabang_description','class' => 'form-control')); ?></td>
						</tr>
