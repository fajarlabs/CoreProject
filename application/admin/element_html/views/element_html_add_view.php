	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('element_html/save',array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						...
						<tr>
							<td colspan="2">
							<?php echo anchor('/element_html','Back', array('title' => 'Back to Quality list', 'class' => 'btn btn-sm btn-primary')); ?>
