...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Product Management <small>Function to create website product</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Product Management - Table</h4>
                </div>
                <div class="panel-body">
					<form id="userRegisterForm" method="post" action="<?php echo base_url(); ?>index.php/product/save/">

						<table class="table table-striped table-bordered">
							<tr>
								<td width="150px" style="padding-top:15px;"><?php echo form_label('Product Reference'); ?></td>
								<td><?php echo form_input(array('type' => 'text','style'=>'width: 100%; height: 35px;', 'name' => 'product_reference','class' => 'easyui-combotree form-control', 'data-options' => 'url:\''.base_url().'index.php/product/list_menu_ref_rest\',method:\'get\',label:\'Select Menu Reference\',labelPosition:\'top\',value:\''.@$id.'\'')); ?></td>
							</tr>
							<tr>
								<td width="150px" style="padding-top:15px;"><?php echo form_label('Product Name') ?></td>
								<td><?php echo form_input(array('id' => 'title','type' => 'text', 'name' => 'product_name','class' => 'form-control','required' => 'required')); ?></td>
							</tr>
							<tr>
								<td width="150px" style="padding-top:15px;"><?php echo form_label('Product Position') ?></td>
								<td><?php echo form_input(array('id' => 'weight','type' => 'number', 'name' => 'weight','class' => 'form-control')); ?></td>
							</tr>
							<tr>
									...
									* <strong><small>For product reference and intervention on entry form</small></strong><br />
									...
									if ($intervention_items != NULL) : 
										foreach($intervention_items as $row) : 
											echo '<input name="intervention_reference[]" type="checkbox" value="'.$row->ID.'" />';
