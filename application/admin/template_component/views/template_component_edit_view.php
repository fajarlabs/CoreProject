...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Template Component Management <small>Function to edit template component</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	...
                	<?php echo form_open_multipart('template_component/update/'.@$id,array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Template Name *') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'template_name','class' => 'form-control','value' => @$item->result()[0]->TEMPLATE_NAME)); ?></td>
						</tr>
						<tr>
