...
<style type="text/css">
  ...
  <tr>
    ...
    <span class="span" style="line-height: 3;margin-left: 60px;">CRUDE LOADING SUMMARY</span></strong></td>
...
<?php 	} ?>
  ...
  <tr>
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">c) density@15°C</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;" ><?php echo check_exist($BL_15_DERAJAT_CELCIUS); ?></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
  ...
  <tr>
   ...
   <tr>
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">b) Shore Tanks Nomination</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_SHORE_TANKS_NOMINATION_KLOBS); ?></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
  ...
  <tr>
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">a) Onboard Quantity (OBQ)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($OBQ_QUANTITY_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($OBQ_QUANTITY_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($OBQ_QUANTITY_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($OBQ_QUANTITY_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($OBQ_QUANTITY_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>
  <tr>
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">b) Ships Figure After Loading (SFAL)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_SFAL_TOV_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_SFAL_TOV_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_SFAL_TOV_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_SFAL_TOV_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_SFAL_TOV_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>
  <tr>
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">c) Free Water</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_FREE_WATER_AL_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_FREE_WATER_AL_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_FREE_WATER_AL_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_FREE_WATER_AL_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SF_FREE_WATER_AL_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>
  <tr>
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">d) Ships Figure After Loading (SFAL)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_GSV_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_GSV_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_GSV_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_GSV_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_GSV_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>
  <tr>
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">e) Ships Figure After Loading (SFAL)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_NSV_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_NSV_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_NSV_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_NSV_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SFAL_NSV_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>
  <?php 
    ...
    ?>  
  <tr>
    <td class="span" style="font-size: 13px;font-family: arial;">f) Vessel Experience Factor</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($VEFL_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($VEFL_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($VEFL_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($VEFL_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($VEFL_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>
  ...
  <?php 
    ...
    ?>  
    <td class="span" style="font-size: 13px;font-family: arial;">g) Ships Loaded (applied VEF-L)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_APPLIED_VEFL_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_APPLIED_VEFL_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_APPLIED_VEFL_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_APPLIED_VEFL_METRICTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_APPLIED_VEFL_LONGTON); ?></td>
  </tr>
  ...
  <tr>
    ...
    ?>  
    <td class="span"  style="font-size: 13px;font-family: arial;">a) Ships Loaded vs Bill of Lading (R1)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VS_BOL_R1_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VS_BOL_R1_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VS_BOL_R1_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VS_BOL_R1_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VS_BOL_R1_METRICTON); ?></td>
  </tr>
 <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>  
  <tr>
    ...
    ?>  
    <td class="span"  style="font-size: 13px;font-family: arial;">Ship's Loaded (VEF applied) vs Bill of Lading (R1)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VEF_APPLIED_VS_BOL_R1_KLOBS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VEF_APPLIED_VS_BOL_R1_KL15); ?> </td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VEF_APPLIED_VS_BOL_R1_BBLS); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VEF_APPLIED_VS_BOL_R1_LONGTON); ?></td>
    <td class="span" align="center" style="font-size: 13px;font-family: arial;"><?php echo check_exist($SL_VEF_APPLIED_VS_BOL_R1_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:5px"></td>
  </tr>
