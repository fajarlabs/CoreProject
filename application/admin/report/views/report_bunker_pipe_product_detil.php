...
<style type="text/css">
  ...
  <tr>
    ...
    <span class="span" style="line-height: 3;margin-left: 60px;">PRODUCT BUNKER PIPE SUMMARY</span></strong></td>
...
<?php 	} ?>
  ...
  <tr>
   ...
   <?php 
    ...
    ?>
   <tr>
    <td class="span" style="font-size: 13px;font-family: arial;" colspan="4">a) Supply Loss (R4)</td>
    <td class="span" style="font-size: 13px;font-family: arial;" align="center"><?php echo check_exist($SUPPLY_LOSS_KLOBS); ?></td>
    <td class="span" style="font-size: 13px;font-family: arial;" align="center"><?php echo check_exist($SUPPLY_LOSS_KL15); ?> </td>
    <td class="span" style="font-size: 13px;font-family: arial;" align="center"><?php echo check_exist($SUPPLY_LOSS_METRIC_TONS); ?></td>
  </tr>
