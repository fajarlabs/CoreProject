...
<style type="text/css">
  ...
  <tr>
    ...
    <span class="span" style="line-height: 3;margin-left: 60px;">PRODUCT DISCHARGE SUMMARY</span></strong></td>
...
<?php 	} ?>
  ...
  <tr>
	 <?php 
      $BL_SFAL_KLOBS = number_format((float)$item->result()[0]->BL_SFAL_KLOBS, 3, '.', '');
      $BL_SFAL_KL15 = number_format((float)$item->result()[0]->BL_SFAL_KL15, 3, '.', '');
      $BL_SFAL_BBLS = number_format((float)$item->result()[0]->BL_SFAL_BBLS, 3, '.', '');
      $BL_SFAL_LONGTON = number_format((float)$item->result()[0]->BL_SFAL_LONGTON, 3, '.', '');
      $BL_SFAL_METRICTON = number_format((float)$item->result()[0]->BL_SFAL_METRICTON, 3, '.', '');
    ?>  
    <td class="span">c) Ship's Figure After Loading (SFAL)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($BL_SFAL_KLOBS); ?></td>
    <td class="span" align="center"><?php echo check_exist($BL_SFAL_KL15); ?></td>
    <td class="span" align="center"><?php echo check_exist($BL_SFAL_BBLS); ?></td>
    <td class="span" align="center"><?php echo check_exist($BL_SFAL_LONGTON); ?></td>
    <td class="span" align="center"><?php echo check_exist($BL_SFAL_METRICTON); ?></td>
  </tr>
  <tr>
  ...
  <tr>
     <?php 
      $SF_SHORE_RECEIVED_KLOBS = number_format((float)$item->result()[0]->SF_SHORE_RECEIVED_KLOBS, 3, '.', '');
      $SF_SHORE_RECEIVED_KL15 = number_format((float)$item->result()[0]->SF_SHORE_RECEIVED_KL15, 3, '.', '');
      $SF_SHORE_RECEIVED_BBLS = number_format((float)$item->result()[0]->SF_SHORE_RECEIVED_BBLS, 3, '.', '');
      $SF_SHORE_RECEIVED_LONGTON = number_format((float)$item->result()[0]->SF_SHORE_RECEIVED_LONGTON, 3, '.', '');
      $SF_SHORE_RECEIVED_METRICTON = number_format((float)$item->result()[0]->SF_SHORE_RECEIVED_METRICTON, 3, '.', '');
    ?>  
    <td class="span">a) Shore Received</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($SF_SHORE_RECEIVED_KLOBS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SF_SHORE_RECEIVED_KL15); ?> </td>
    <td class="span" align="center"><?php echo check_exist($SF_SHORE_RECEIVED_BBLS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SF_SHORE_RECEIVED_LONGTON); ?></td>
    <td class="span" align="center"><?php echo check_exist($SF_SHORE_RECEIVED_METRICTON); ?></td>
  </tr>
   
   <tr>
     <?php 
      $SF_STU = number_format((float)$item->result()[0]->SF_STU, 3, '.', '');
    ?>  
    <td class="span">b) Shore Tanks Used</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($SF_STU); ?></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
  ...
  <tr>
  <?php 
      $SF_DENSITY_15C = number_format((float)$item->result()[0]->SF_DENSITY_15C, 3, '.', '');
    
    ?>  
    <td class="span">c) density@15°C</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($SF_DENSITY_15C); ?></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
    <td class="span" align="center"></td>
...
<tr>
  ...
  <tr>
    ...
    ?>  
    <td class="span">a) Ship Figure Before Discharge</td>
    <td class="span">&nbsp;</td>
  ...
  <tr>
    ...
    ?>  
    <td class="span">c) Remaining On Board Quantity (ROB)</td>
    <td class="span">&nbsp;</td>
  ...
  <tr>
   <?php 
    ...
    ?>  
    <td class="span">d) Ship Figure Before Discharge</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($SFBD_GSV_KLOBS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFBD_GSV_KL15); ?> </td>
    <td class="span" align="center"><?php echo check_exist($SFBD_GSV_BBLS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFBD_GSV_LONGTON); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFBD_GSV_METRICTON); ?></td>
  </tr>
  ...
  <tr>
     <?php 
      $SFAL_VS_SF_KLOBS = number_format((float)$item->result()[0]->SFAL_VS_SF_KLOBS, 3, '.', '');
      $SFAL_VS_SF_KL15 = number_format((float)$item->result()[0]->SFAL_VS_SF_KL15, 3, '.', '');
      $SFAL_VS_SF_BBLS = number_format((float)$item->result()[0]->SFAL_VS_SF_BBLS, 3, '.', '');
      $SFAL_VS_SF_METRICTON = number_format((float)$item->result()[0]->SFAL_VS_SF_METRICTON, 3, '.', '');
      $SFAL_VS_SF_LONGTON = number_format((float)$item->result()[0]->SFAL_VS_SF_LONGTON, 3, '.', '');
    ?>  
    <td class="span">b) Ship's Fig. After Loading vs Ship's Fig. Before Discharge (R2)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($SFAL_VS_SF_KLOBS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFAL_VS_SF_KL15); ?> </td>
    <td class="span" align="center"><?php echo check_exist($SFAL_VS_SF_BBLS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFAL_VS_SF_LONGTON); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFAL_VS_SF_METRICTON); ?></td>
  </tr>
  <tr>
     <?php 
      $SFBD_VS_SR_KLOBS = number_format((float)$item->result()[0]->SFBD_VS_SR_KLOBS, 3, '.', '');
      $SFBD_VS_SR_KL15 = number_format((float)$item->result()[0]->SFBD_VS_SR_KL15, 3, '.', '');
      $SFBD_VS_SR_BBLS = number_format((float)$item->result()[0]->SFBD_VS_SR_BBLS, 3, '.', '');
      $SFBD_VS_SR_METRICTON = number_format((float)$item->result()[0]->SFBD_VS_SR_METRICTON, 3, '.', '');
      $SFBD_VS_SR_LONGTON = number_format((float)$item->result()[0]->SFBD_VS_SR_LONGTON, 3, '.', '');
    ?>  
    <td class="span">c) Ship's Fig. Before Discharge vs Shore Received (R3)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($SFBD_VS_SR_KLOBS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFBD_VS_SR_KL15); ?> </td>
    <td class="span" align="center"><?php echo check_exist($SFBD_VS_SR_BBLS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFBD_VS_SR_LONGTON); ?></td>
    <td class="span" align="center"><?php echo check_exist($SFBD_VS_SR_METRICTON); ?></td>
  </tr>
  <tr>
     <?php 
      $SR_VS_BOL_KLOBS = number_format((float)$item->result()[0]->SR_VS_BOL_KLOBS, 3, '.', '');
      $SR_VS_BOL_KL15 = number_format((float)$item->result()[0]->SR_VS_BOL_KL15, 3, '.', '');
      $SR_VS_BOL_BBLS = number_format((float)$item->result()[0]->SR_VS_BOL_BBLS, 3, '.', '');
      $SR_VS_BOL_METRICTON = number_format((float)$item->result()[0]->SR_VS_BOL_METRICTON, 3, '.', '');
      $SR_VS_BOL_LONGTON = number_format((float)$item->result()[0]->SR_VS_BOL_LONGTON, 3, '.', '');
    ?>  
    <td class="span">d) Shore Received vs Bill of Lading (R4)</td>
    <td class="span">&nbsp;</td>
    <td class="span" align="center"><?php echo check_exist($SR_VS_BOL_KLOBS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SR_VS_BOL_KL15); ?> </td>
    <td class="span" align="center"><?php echo check_exist($SR_VS_BOL_BBLS); ?></td>
    <td class="span" align="center"><?php echo check_exist($SR_VS_BOL_LONGTON); ?></td>
    <td class="span" align="center"><?php echo check_exist($SR_VS_BOL_METRICTON); ?></td>
  </tr>
  <tr>
    <td colspan="7" class="span" style="height:20px"></td>
  </tr>
