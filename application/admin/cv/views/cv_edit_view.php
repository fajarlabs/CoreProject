					...
					<table class="table table-striped  table-bordered">
						<tr>
							...
							<td>
								...
								<div class="row">
									<div class="col-md-8">
										<?php echo form_input(array('type' => 'text', 'readonly' => '', 'name' => 'nama','class' => 'form-control','value' => @$item->result()[0]->NAMA,'required' => 'required')); ?>
									</div>
									<div class="col-md-4">
										<input disabled <?PHP if(@$item->result()[0]->GENDER=="L") echo "checked"; ?> type="radio" value="L" name="gender" required=""> Male &nbsp;
										<input disabled <?PHP if(@$item->result()[0]->GENDER=="P") echo "checked"; ?> type="radio" value="P" name="gender" required> Female
									</div>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="row">
									<div class="col-md-8">
										<?php echo form_input(array('readonly' => '','type' => 'text', 'name' => 'placedate','class' => 'form-control','required' => 'required','value' => @$item->result()[0]->PLACE_BIRTHDATE,'placeholder' => 'Place of birth','maxlength' => 100)); ?>
									</div>
									<div class="col-md-4">
										<?php echo form_input(array('readonly' => '','type' => 'text', 'name' => 'birthdate','id' => 'birthdate','class' => 'form-control','required' => 'required','placeholder' => 'Birthdate')); ?>
									</div>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td><?php echo form_input(array('readonly' => '','type' => 'email', 'name' => 'email','class' => 'form-control','value' => @$item->result()[0]->EMAIL,'required' => 'required','maxlength' => 150)); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<select disabled name="position" class="form-control" required="">
						...
						<tr>
							...
							<td>
								<input disabled required onclick="get_type_location()" <?Php if(@$item->result()[0]->TYPE_LOCATION=="1") echo "checked"; ?> type="radio" value="1" name="type_location" id="type_location"> Kantor Pusat
								<input disabled required onclick="get_type_location()" <?Php if(@$item->result()[0]->TYPE_LOCATION=="2") echo "checked"; ?> type="radio" value="2" name="type_location" id="type_location"> Cabang <br/><br/>
								<select disabled name="sbu" id="sbu" class="form-control" <?Php if(@$item->result()[0]->TYPE_LOCATION!="1") echo "style='display:none' "; ?>>
								...
								<select disabled name="cabang" id="cabang" class="form-control"  <?Php if(@$item->result()[0]->TYPE_LOCATION!="2") echo "style='display:none' "; ?>>
