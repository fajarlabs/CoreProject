                ...
                <div class="panel-body" style="overflow-x: hidden;">
					...
					<table class="table table-striped  table-bordered">
						<tr>
							...
							<td><?php echo form_input(array('type' => 'text', 'name' => 'position','class' => 'form-control','value' => @$item->result()[0]->POSISI,'required' => 'required')); ?></td>
						</tr>
						<tr>
							<td width="150px" style="padding-top:15px;"><?php echo form_label('Name*') ?></td>
							<td><?php echo form_input(array('type' => 'text', 'name' => 'nama','class' => 'form-control','value' => @$item->result()[0]->NAMA,'required' => 'required')); ?></td>
						</tr>
						<tr>
							...
							<td>
								...
								* 5MB Maximum for Attachment File Size
								<br /><br />
								<?php echo anchor(base_url().'uploads/cv_files/'.@$item->result()[0]->UPLOAD_FILE, 'Preview or download', 'class="btn btn-xs btn-success" title="Preview or download"'); ?>
							</td>
						</tr>
