...
<div id="content" class="content">
	...
	<!-- begin page-header -->
	<h1 class="page-header">Log Monitoring <small>Function to monitoring client activity</small></h1>
	<!-- end page-header -->
	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Log Monitoring Client - Table</h4>
                </div>
                <div class="panel-body">
				    <table id="dg" class="easyui-datagrid" style="width:100%;min-height:400px"
				            url="<?php echo base_url(); ?>index.php/log_monitoring_client/page_list_rest"
