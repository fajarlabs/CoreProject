...
class File_manager_basic extends MY_Controller 
{
	public function __construct() 
	{
		parent::__construct();
		$this->load->model(array("user/User_model","user/User_group_model","menu/Menu_model","file_manager/File_manager_model"));
    	...
    	$this->data['html_js'] = '
			...
			<script>
				...
				{
					window.open("'.base_url().'index.php/file_manager_basic/add","_self");
				}

				function editFileManager()
				{
					var row = $("#dg").datagrid("getSelected");
					window.open("'.base_url().'index.php/file_manager_basic/edit/"+row.FILE_MANAGER_ID,"_self");
				}
				...
				function destroyFileManager()
				{
					if(confirm("Are you sure ?")) {
						var row = $("#dg").datagrid("getSelected");
						window.open("'.base_url().'index.php/file_manager_basic/delete/"+row.FILE_MANAGER_ID,"_self");
					}
				}
	...
	public function index()
	{
		...
		$this->load->view('file_manager_basic_view',$this->data);
	...
	public function add()
	{
		$this->data['title'] = "File Manager Management";
		$this->load->view('admin/header',$this->data);
		$this->load->view('file_manager_add_basic_view',$this->data);
		$this->load->view('admin/footer',$this->data);
	}
	...
	public function edit($id=0)
	{
		...
		$this->load->view('admin/header',$this->data);
		$this->load->view('file_manager_edit_basic_view',$this->data);
		$this->load->view('admin/footer',$this->data);
	}
