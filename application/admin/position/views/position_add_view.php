	    ...
	    <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow-x: hidden;">
                	<br />
                	<?php echo form_open_multipart('position/save',array('id' => 'form_add')); ?>
					<table class="table table-striped  table-bordered">
						<tr>
							...
							<td>
								...
								<div class="row">
									<div class="col-md-12">
										<?php echo form_input(array('type' => 'text', 'name' => 'position','class' => 'form-control','required' => 'required','maxlength' => 100)); ?>
									</div>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
							<?php echo anchor('/position','Back', array('title' => 'Back to Position list', 'class' => 'btn btn-sm btn-primary')); ?>
