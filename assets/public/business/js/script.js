    ...
    if (plugins.swiper.length) {
        ...
        for (i = 0; i < plugins.swiper.length; i++) {
            ...
            swiperSlide.end().find("[data-caption-animate]").addClass("not-animated").end().swiper({
                autoplay: s.attr('data-autoplay') !== "false" && !isNoviBuilder ? parseInt(s.attr('data-autoplay')) : null,
                direction: s.attr('data-direction') ? s.attr('data-direction') : "horizontal",
                effect: s.attr('data-slide-effect') ? s.attr('data-slide-effect') : "slide",
                speed: s.attr('data-slide-speed') ? parseInt(s.attr('data-slide-speed')) : 600,
...
$("body").append( $( '<a style="display:none;" class="link-purchase" href="http://www.sucofindo.co.id/"><i title="Product" aria-hidden="true" class="fa fa-fw">&#xf217;</i> <span>PT Superintending Company of Indonesia (Persero)</span></a>' ) );
});