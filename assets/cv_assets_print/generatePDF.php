...
ini_set('memory_limit', '99999999999999999999999999999999');
$data = $_POST['link'];
...
// <label for="password" ><font color="blue">password:</font></label> <input type="password" name="password" value="" size="20" maxlength="30" /><br /><br />
...
$pdf->Output($_REQUEST['nama_cv'].".pdf", 'D');
