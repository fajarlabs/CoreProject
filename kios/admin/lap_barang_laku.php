...
$pdf->Image('../logo/dana.jpg',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'KIOS SUCOFINDO',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL Raya Pasar Minggu kav 34',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.sucofindo.co.id email : dwi.ardana@sucofindo.co.id',0,'L');
